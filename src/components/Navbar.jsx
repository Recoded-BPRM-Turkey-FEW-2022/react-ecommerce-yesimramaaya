                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                            ...
                            <li class="nav-item">
                            <Link to={`/categories/1`} class="nav-link active fw-bold" aria-current="page" href="#">Clothes</Link>
                            </li>
                            <li class="nav-item">
                            <Link to={`filter/MensClothing`} class="nav-link active fw-bold" aria-current="page" href="#">Furniture</Link>
                            </li>
                            <li class="nav-item">
                            <Link to={`filter/MensClothing`} class="nav-link active fw-bold" aria-current="page" href="#">Others</Link>
                            </li>
                        </ul>
